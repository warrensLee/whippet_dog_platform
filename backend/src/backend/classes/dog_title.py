...
from backend.utils.email_service import send_titles_email
from backend.utils.generate_pdf import generate_title_pdf
...
class DogTitle:
    ...
    def delete(self, cwa_number, title):
        """Delete dog title from backend.database. Returns True on success, raises Error on failure."""
        try:
            execute(
                """
