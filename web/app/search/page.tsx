          ...
          <div className="w-full max-w-2xl text-center">
            ...
            <form method="GET" action="/search" className="mt-7 flex gap-3">
              <input
                name="q"
                defaultValue={q}
                placeholder="Search dog name, CWA number, owner..."
        ...
        <div className="max-w-6xl mx-auto px-4">
            ...
            {pagedItems.map((d) => (
              ...
              >
                ...
                <div className="mt-3 grid grid-cols-2 gap-y-1 text-sm text-[#12301D]/70">
                  <div><span className="font-medium text-[#12301D]/80">CWA</span>: {d.cwaNumber || "—"}</div>
                  <div><span className="font-medium text-[#12301D]/80">Year</span>: {d.birthYear || "—"}</div>
          ...
          {!loading && !error && pagedItems.length === 0 && (
            <div className="mt-6 rounded-2xl border border-black/10 bg-white/80 px-4 py-6 text-sm text-[#12301D]/70 shadow-sm">
              No matches. Try a different name or CWA number.
            </div>
          )}
        </div>
      </section>
