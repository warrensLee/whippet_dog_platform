...
function AdminEventsPage() {
    ...
    const loadEvents = React.useCallback(
        async function () {
            ...
            try {
                if (user === "NotAuthenticated" || user === undefined) return;
                const usp = new URLSearchParams();
                usp.set("q", q);
                usp.set("page", String(page));
                usp.set("limit", String(limit));
                usp.set("sort", sort);
                if (!user.hasPermission("editAllMeet")) {
    ...
    return (
        <AuthGuard permissions={["editOwnMeet"]}>
            <main className="pt-24 bg-[#1F4D2E]">
                ...
                <section className="bg-[#E7F0E9] pt-12 pb-24">
                    <div className="max-w-6xl mx-auto px-4">
                        {/*
                        I was asked to remove the completed meets from this. I thought it looked wierd and empty with just 1 component for the total results, we display the total results in other places.
                        I went ahead and commented out the code for the entire top panel. If they don't ask for that back you can remove it. Done: Aug 19, 2026
