...
export default function StatPill({ label, value, accent }: {
    ...
    return (
        <div
            className={`flex flex-grow flex-col items-center justify-center rounded-2xl px-4 py-4 shadow-sm ${accent
        ...
        >
            ...
            <span
                className={`mt-1 text-[10px] font-semibold uppercase tracking-widest ${accent ? "text-white/70" : "text-[#12301D]/50"
                    }`}
            >
                {label}
            </span>
