...
CREATE TABLE `Dog` (
    ...
    `DPCPoints` DECIMAL(5,2) NOT NULL DEFAULT 0,
    `ManualMeetPointsAdjustment` DECIMAL(6,2) NOT NULL DEFAULT 0,
    `ManualARXPointsAdjustment` DECIMAL(6,2) NOT NULL DEFAULT 0,
    `ManualNARXPointsAdjustment` DECIMAL(6,2) NOT NULL DEFAULT 0,
    `ManualShowPointsAdjustment` DECIMAL(6,2) NOT NULL DEFAULT 0,
    `ManualDPCPointsAdjustment` DECIMAL(6,2) NOT NULL DEFAULT 0,
    `ManualMeetAppearancesAdjustment` DECIMAL(6,2) NOT NULL DEFAULT 0,
    `ManualMeetWinsAdjustment` DECIMAL(6,2) NOT NULL DEFAULT 0,
    `ManualDPCLegsAdjustment` DECIMAL(6,2) NOT NULL DEFAULT 0,
    `ManualHighCombinedWinsAdjustment` DECIMAL(6,2) NOT NULL DEFAULT 0,
    `PublicNotes` TEXT,
    `PrivateNotes` TEXT,
    `DNA` VARCHAR(50),
    `SireDNA` VARCHAR(50),
