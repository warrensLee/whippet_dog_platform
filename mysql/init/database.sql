...
CREATE TABLE `Dog` (
    ...
    `MeetPoints` DECIMAL(9,2),
    `ARXPoints` DECIMAL(9,2),
    `NARXPoints` DECIMAL(9,2),
    `ShowPoints` DECIMAL(6,2),
    `DPCLegs` SMALLINT,
    `MeetWins` DECIMAL(9,2),
    `MeetAppearences` DECIMAL(9,2),
    `HighCombinedWins` DECIMAL(9,2),
    `AOMEarned` DECIMAL(9,2),
    `DPCPoints` DECIMAL(9,2) NOT NULL DEFAULT 0,
    `ManualMeetPointsAdjustment` DECIMAL(9,2) NOT NULL DEFAULT 0,
    `ManualARXPointsAdjustment` DECIMAL(9,2) NOT NULL DEFAULT 0,
    `ManualNARXPointsAdjustment` DECIMAL(9,2) NOT NULL DEFAULT 0,
    `ManualShowPointsAdjustment` DECIMAL(9,2) NOT NULL DEFAULT 0,
    `ManualDPCPointsAdjustment` DECIMAL(9,2) NOT NULL DEFAULT 0,
    `ManualMeetAppearancesAdjustment` DECIMAL(9,2) NOT NULL DEFAULT 0,
    `ManualMeetWinsAdjustment` DECIMAL(9,2) NOT NULL DEFAULT 0,
    `ManualDPCLegsAdjustment` DECIMAL(9,2) NOT NULL DEFAULT 0,
    `ManualHighCombinedWinsAdjustment` DECIMAL(9,2) NOT NULL DEFAULT 0,
    `HistoricalMeetPoints1` DECIMAL(9,2) DEFAULT NULL,
    `HistoricalMeetPoints2` DECIMAL(9,2) DEFAULT NULL,
    `HistoricalMeetPoints3` DECIMAL(9,2) DEFAULT NULL,
    `PublicNotes` TEXT,
    `PrivateNotes` TEXT,
    `DNA` VARCHAR(50),
    `SireDNA` VARCHAR(50),
...
CREATE TABLE `MeetResults` (
    ...
    `ShowPlacement` VARCHAR(4),
    `ShowPoints` DECIMAL(4,2),
    `DPCLeg` CHAR(1),
    `HCScore` INT,
    `HCLegEarned` CHAR(1),
